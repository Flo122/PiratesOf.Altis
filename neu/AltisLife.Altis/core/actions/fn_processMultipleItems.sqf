...
{
	case "bronze": {[["zinnp","copper_r"],[1,1],"bronze",1,"bronze",5000];};
	case "schmuck": {[["silberp","diamondc"],[1,1],"schmuck",1,"schmuck",5000];};
	case "pbrau": {[["zuckerip","getreideip"],[1,1],"pbrau",1,"pbrai",5000];};
	case "kkugel": {[["eisenp","kkugel"],[1,1],"kkugel",1,"kkugel",5000];};
	case "spulver": {[["schwefelp","spulver"],[1,1],"spulver",1,"spulver",5000];};
	case "pkugel": {[["kkugel","spulver"],[1,1],"pkugel",1,"pkugel",5000];};
	default {[]};
};
