...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "sek_s": {_var = "license_cop_sek_s"}; //Swat License cost
			...
			case "handy": {_var = "license_civ_handy"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_cop_sek_s": {_var = "sek_s"}; //Swat License cost
			...
			case "lisence_civ_plastik": {_var = "plastik"};
			case "license_civ_gusseisen": {_var = "gusseisen"};
			case "license_civ_handy": {_var = "handy"};
