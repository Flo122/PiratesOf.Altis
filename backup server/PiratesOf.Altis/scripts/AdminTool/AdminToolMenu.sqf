_pathtovehiclescars = "scripts\AdminTool\vehicles\Autos\";
_pathtovehicleshelis = "scripts\AdminTool\vehicles\Helis\";
_pathtovehiclespanzer = "scripts\AdminTool\vehicles\Panzer\";
_pathtovehiclesoffroad = "scripts\AdminTool\vehicles\Offroad\";
_pathtovehiclesflugzeug = "scripts\AdminTool\vehicles\Flugzeug\";
_pathtovehiclesMPS = "scripts\AdminTool\weapons\MPS\";
_pathtovehiclesSturmgewehre = "scripts\AdminTool\weapons\Sturmgewehre\";
_pathtovehiclesSniper = "scripts\AdminTool\weapons\Sniper\";
_pathtovehiclesPistolen = "scripts\AdminTool\weapons\Pistolen\";
_pathtovehiclesMG = "scripts\AdminTool\weapons\MGS\";
_pathtotools = "scripts\AdminTool\tools\";
