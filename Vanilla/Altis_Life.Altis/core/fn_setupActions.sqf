...
switch (playerSide) do
{
	case civilian:
	{
		...
		life_actions = life_actions + [player addAction["Objekte entfernen",life_fnc_seizeObjects,cursorTarget,0,false,false,"",'count(nearestObjects [player,["weaponholder"],3])>0']];
	};
};