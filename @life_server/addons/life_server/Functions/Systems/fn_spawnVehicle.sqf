...
{
	serv_sv_use = serv_sv_use - [_vid];
	[[_price,{life_atmcash_pirates = life_atmcash_pirates + _this;}],"BIS_fnc_spawn",_unit,false] spawn life_fnc_MP;
...
if((_vInfo select 1) == "APH" && (_vInfo select 2) == "C_Offroad_01_F") then
{
