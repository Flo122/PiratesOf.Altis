...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Quadbike = ["C_Kart_01_Vrana_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Blu_F","I_Quadbike_01_F", "C_Quadbike_01_F", "O_Quadbike_01_F", "B_G_Quadbike_01_F", "B_Quadbike_01_F", "CAF_Quadbike_OD", "CAF_Quadbike_AR", "Marinir_Quadbike_01_FG", "B_mas_mar_Quadbike_01_F"];
	...
	IL_Supported_Rubberboat = ["C_Boat_Civil_01_police_F", "B_Boat_Armed_01_minigun_F", "I_Boat_Transport_01_F", "O_Boat_Transport_01_F", "B_G_Boat_Transport_01_F", "B_Boat_Transport_01_F", "C_Boat_Civil_01_F", "C_Rubberboat", "O_Lifeboat", "B_Lifeboat", "Marinir_duck_base_F", "B_mas_mar_Boat_Transport_01_F"];
	...
	IL_Supported_Heli = ["B_Heli_Light_01_F", "O_Heli_Light_02_unarmed_F", "I_Heli_light_03_unarmed_F"];
	IL_Supported_Helilight = ["B_Heli_Light_01_F"];
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_VAN + IL_Supported_SUV + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_OFFROAD + IL_Supported_Helilight;
	IL_Supported_Cargo_NonVeh_HEMTT = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20;
	IL_Supported_Cargo_HEMTT = IL_Supported_Cargo_Veh_HEMTT + IL_Supported_Cargo_NonVeh_HEMTT;
	
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_SUV + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_OFFROAD;
	IL_Supported_Cargo_NonVeh_Mohawk = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel;
