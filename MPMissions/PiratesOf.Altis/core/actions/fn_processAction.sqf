...
if(_hasLicense) then
{
	...
	if(animationState player=="amovpercmstpsnonwnondnon_amovpercmstpssurwnondnon") exitWith {5 cutText ["","PLAIN"]; life_is_processing = false;_ui = "osefStatusBar" call BIS_fnc_rscLayer;_ui cutRsc["osefStatusBar","PLAIN"];};
