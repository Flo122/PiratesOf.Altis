...
{
	if(life_cash_pirates < _cost) exitWith {hint format["Du benoetigst $%1 um ohne Lizenz zu verarbeiten.",[_cost] call life_fnc_numberText]; 5 cutText ["","PLAIN"]; life_is_processing = false;};
