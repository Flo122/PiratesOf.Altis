...
if(life_cash_pirates > 0) then
{
	...
	[[1,format[localize "STR_NOTF_Robbed",_robber getVariable["realname",name _robber],profileName,[life_cash_pirates] call life_fnc_numberText]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	life_cash_pirates = 0;
}
	else
{
