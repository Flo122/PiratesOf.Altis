...
if(isPlayer _curTarget && _curTarget isKindOf "Man") then {
	...
	if(!(player getVariable["restrained",false]) && (_curTarget getVariable["restrained",false]) && !dialog && playerSide == civilian) then {
	...
	if(_isVehicle) then {
		if(!(player getVariable["restrained",false]) && !dialog) then {
