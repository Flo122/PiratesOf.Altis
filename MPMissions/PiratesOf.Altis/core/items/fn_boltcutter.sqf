...
*/
private["_building","_door","_doors","_cpRate","_title","_progressBar","_titleText","_cp","_ui","house"];
...
if((nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"]) == _building OR (nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) == _building) then {
	...
	[[0,"STR_ISTR_Bolt_AlertHouse",true,[profileName],[(_house getVariable "house_owner")]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
};
