...
switch(_type) do
{
	...
	case 1:
	{
		...
		hint format["Du hast %1 die Nachricht: %2 gesendet",name life_smartphoneTarget,_msg];	
		ctrlShow[88885, true];
		closeDialog 88883;
	};
	//copmessage
	case 2:
	{
		...
		_to = "Die Polizei";
		hint format["Du hast %1 die Nachricht: %2 gesendet",_to,_msg];
	...
	case 4:
	{
		...
		hint format["Du hast eine Nachricht an die Sanitaeter versendet.",_msg];
	...
	case 5:
	{
		...
		hint format["Adminnachricht versendet an: %1 - Nachricht: %2",name life_smartphoneTarget,_msg];
		closeDialog 88883;
	};
	//emergencyloading
	case 6:
	...
	case 7:
	{
		...
		hint format["Adminnachricht versendet an alle: %1",_msg];
		closeDialog 887890;
	};
	...
	case 8:
	{
		...
		if(_msg == "") exitWith {hint "Du musst eine Nachricht eingeben!";ctrlShow[888889,true];};
		[[ObjNull,_msg,player,6],"TON_fnc_handleMessages",false] spawn life_fnc_MP;
		hint format["Du hast eine Nachricht an alle Pannenhelfer versendet.",_msg];
	...
	case 9:
	{
		...
		hint format["Polizeinachricht gesendet an alle Spieler: %1",_msg];
		closeDialog 888808;
	};
};