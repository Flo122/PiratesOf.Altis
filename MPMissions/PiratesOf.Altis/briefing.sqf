...
*/	
	...
	player createDiaryRecord["serverrules",
		[
			"Kommunikationsregeln",
				...
				4. Der Sidechat ist nicht für RP-Situationen gedacht. Ankuendigungen im Sidechat sind nicht gueltig.<br/>
	...
	player createDiaryRecord["behavioral",
		[
			"Polizeiregeln",
				...
				12. Sinkt das Verhaeltnis von Polizisten und Zivilisten unter 1:5, ist ein Polizist, der aktuell als Zivilist online ist, dazu verpflichtet, sich schnellstmoeglich zum Polizeidienst zu melden.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["behavioral",
		[
			"Rebellenregeln",
				...
				- Ankuendigung ueber Piratennews<br/>
	...
	player createDiaryRecord["behavioral",
		[
			"Strassen-/Luftverkehr",
				...
				- Ifrit, Geländewagen (bewaffnet) sowie alle in illegale Hanlungen involvierte Fahrzeuge<br/>
	...
	player createDiaryRecord["penality",
		[
			"Gefaengniszeiten bei Nichtbezahlen der Strafe",
				"
				Bei Tickets ueber einer Millionen Dollar oder bei mehrfachem Mord oder fahrlaessiger Toetung, rebellischen Uebernahmen oder Terrorismus sowie Bankraub besteht keine Moeglichkeit, das Ticket zu bezahlen. Der Verdaechtige wird sofort inhaftiert.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["penality",
		[
			"Kapitalverbrechen",
				"
				Anstiftung zu einem Verbrechen: Bussgeld des Verbrechens : 2<br/>
				Angriff auf Kraftwerke: 100.000$<br/>
				Beschuss von Personen/bemannten Fahrzeugen: 20.000$<br/>
				Beschuss mit Personenschaden: 75.000$<br/>
				fahrlaessige Toetung: 100.000$<br/>
				Mord: 200.000$<br/>
				versuchte Entfuehrung: 50.000$<br/>
				Entfuehrung: 100.000$<br/>
				versuchter Raub: 50.000$<br/>
				Raub: 100.000$<br/>
				versuchter Bankraub: 75.000$<br/>
				Bankraub: 150.000$<br/>
				rebellische Uebernahme: 200.000$<br/>
				Terrorismus: 600.000$<br/><br/>
				"
		]
	];
